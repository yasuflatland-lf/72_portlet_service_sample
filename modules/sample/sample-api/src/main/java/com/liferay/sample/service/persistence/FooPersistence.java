...
public interface FooPersistence extends BasePersistence<Foo> {
	 ...
	 * @return the matching foos
	 */
	public java.util.List<Foo> findByTitle(String title);
	 ...
	 * @return the range of matching foos
	 */
	public java.util.List<Foo> findByTitle(String title, int start, int end);
	 ...
	 * @return the ordered range of matching foos
	 */
	public java.util.List<Foo> findByTitle(
