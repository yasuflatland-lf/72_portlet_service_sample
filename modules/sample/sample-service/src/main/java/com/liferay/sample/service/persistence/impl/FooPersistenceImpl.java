...
public class FooPersistenceImpl
	 ...
	 */
	@Override
	public Foo findByTitle_First(
			String title, OrderByComparator<Foo> orderByComparator)
		throws NoSuchFooException {
	 ...
	 */
	@Override
	public Foo[] findByTitle_PrevAndNext(
			long fooId, String title, OrderByComparator<Foo> orderByComparator)
		throws NoSuchFooException {
		...
		try {
			...
			array[0] = getByTitle_PrevAndNext(
				session, foo, title, orderByComparator, true);

			array[1] = foo;

			array[2] = getByTitle_PrevAndNext(
				session, foo, title, orderByComparator, false);
	...
	protected Foo getByTitle_PrevAndNext(
		Session session, Foo foo, String title,
		OrderByComparator<Foo> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_TITLE_TITLE_3 =
		"(foo.title IS NULL OR foo.title = '')";
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.liferay.sample.model.Foo"),
			true);
	}
